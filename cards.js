...
var deck = [
    ...
    new card('Nut', 'nut'),
    new card('Monkey', 'monkey'),   
    new card('Fencing', 'fencing'),     
    new card('Bird', 'bird'),    
    new card('Sword', 'sword'),    
    new card('Motor', 'motor'),

    new card('Field', 'field'),        
    new card('Fly', 'fly'),    
    new card('Gun', 'gun'),    
    new card('Stamp', 'stamp'),    
    new card('Beetle', 'beetle'),
    new card('Sun', 'sun'),    
    new card('Summer', 'summer'),    
    new card('Ice', 'ice'),    
    new card('Dust', 'dust'),    
    new card('Bible', 'bible'),

    new card('Drum', 'drum'),    
    new card('Fog', 'fog'),    
    new card('Football', 'football'),    
    new card('Bridge', 'bridge'),    
    new card('Pulley', 'pulley'),
    new card('Toe', 'toe'),    
    new card('Woman', 'woman'),    
    new card('Plow', 'plow'),    
    new card('Sunset', 'sunset'),    
    new card('Gate', 'gate'),

    new card('Clock', 'clock'),    
    new card('Car', 'car'),    
    new card('Road', 'road'),    
    new card('Zoo', 'zoo'),    
    new card('Museum', 'museum'),
    new card('Painting', 'painting'),    
    new card('Sand', 'sand'),    
    new card('Menu', 'menu'),    
    new card('Book', 'book'),    
    new card('Ashtray', 'ashtray'),

    new card('Lighter', 'lighter'),    
    new card('Hip', 'hip'),    
    new card('Mouse', 'mouse'),    
    ...
    new card('Pocket', 'pocket'),     
    new card('Plane', 'plane'),    
    new card('Pill', 'pill'),   
    new card('Ticket', 'ticket'),       
    new card('Hammer', 'hammer'),
    new card('Circle', 'circle'),   
    new card('Smoke', 'smoke'),    
    new card('Sky', 'sky'),     
    new card('Referee', 'referee'),   
    new card('Pepper', 'pepper'),
    
    new card('Ocean', 'ocean'),    
    new card('Triangle', 'triangle'),    
    new card('Octopus', 'octopus'),    
    new card('Magnet', 'magnet'),    
    new card('Spaghetti', 'spaghetti'),
    new card('Milk', 'milk'),    
    ...
    new card('Eye', 'eye'),    
    new card('Television', 'television'),    
    new card('Wedding', 'wedding'),    
    new card('Ring', 'ring'),    
    new card('Wine', 'wine'),
    new card('Pig', 'pig'),    
    ...
    new card('Gondola', 'gondola'),    
    new card('Telephone', 'telephone'),        
    new card('Sleet', 'sleet'),    
    new card('Toll', 'toll'),    
    new card('Notebook', 'notebook'),   
    new card('File', 'file'),    
    new card('Clouds', 'clouds'),      
    new card('Chimney', 'chimney'),    
    new card('Sailboat', 'sailboat'),     
    new card('Mirrors', 'mirrors'),
    
    new card('Volcano', 'volcano'),    
    new card('Suitcase', 'suitcase'),   
    new card('Fish', 'fish'),     
    new card('Lamp', 'lamp'),    
    new card('Library', 'library'),
    new card('University', 'university'),    
    new card('Barbecue', 'barbecue'),         
    new card('Watch', 'watch'),    
    new card('Canister', 'canister'),    
    new card('Coffee', 'coffee'),    
    
    new card('Toxic waste', 'toxic_waste'),    
    new card('Ribcage', 'ribcage'),    
    new card('Math', 'math'),      
    new card('Brunch', 'brunch'),   
    new card('Flag', 'flag'),
    new card('Helmet', 'helmet'),     
    new card('Cactus', 'cactus'),    
    new card('Cowboy', 'cowboy'),    
    new card('Butterfly', 'butterfly'),    
    new card('Cube', 'cube'),
    
    new card('X-ray', 'xray'),    
    new card('Money', 'money'),    
    new card('Magazine', 'magazine'),    
    new card('Ink', 'ink'),    
    new card('Tea', 'tea'),    
    new card('Balloon', 'balloon'),    
    new card('Lobster', 'lobster'),    
    new card('Train', 'train'),    
    new card('Perfume', 'perfume'),    
